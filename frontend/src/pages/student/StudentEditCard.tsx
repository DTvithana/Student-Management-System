        ...
        <Box p={1} width="740px" sx={{ borderRadius: "15px" }}>
          ...
          <Grid container spacing={2} paddingTop="2rem">
            ...
            <InputComponent
              Md={6}
              label={"Last Name"}
              objRef={register("lName")}
              error={""}
            />
            <InputComponent
              Md={15}
              label={"Address"}
              objRef={register("address")}
              error={""}
            />
            <InputComponent
              Md={15}
            ...
            <InputComponent
              Md={15}
              label={"Degree"}
              objRef={register("degree")}
              error={""}
            />
            <InputComponent
              Md={15}
              label={"Course 1"}
              objRef={register("course1")}
              error={""}
            />
            <InputComponent
              Md={15}
              label={"Course 2"}
              objRef={register("course2")}
              error={""}
            />
            <InputComponent
              Md={15}
              label={"Course 3"}
              objRef={register("course3")}
              error={""}
            />
            <InputComponent
              Md={15}
              label={"Course 4"}
              objRef={register("course4")}
              error={""}
            />
            ...
            <Grid item xs={6} md={1.5}>
              <Button
                type="submit"
                variant="contained"
                sx={{ width: "95px", borderRadius: "12px" }}
              >
                Save
              </Button>
            </Grid>
